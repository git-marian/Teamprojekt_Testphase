...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\maria\\Documents\\Teamprojekt_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    ternusObjLeft = visual.ShapeStim(
        ...
        ori=0.0, pos=(-3, 2), draggable=False, anchor='center',
        lineWidth=1.0,
    ...
    ternusObjMiddle = visual.ShapeStim(
        ...
        size=(1.6), vertices='circle',
        ori=0.0, pos=(-1, 2), draggable=False, anchor='center',
        lineWidth=1.0,
        colorSpace='rgb', lineColor=[-1.0000, -1.0000, -1.0000], fillColor=[-1.0000, -1.0000, -1.0000],
    ...
    Barrier = visual.Rect(
        ...
        width=(0.1, 2)[0], height=(0.1, 2)[1],
        ori=0.0, pos=(2, 2), draggable=False, anchor='center',
        lineWidth=1.0,
        colorSpace='rgb', lineColor='white', fillColor='white',
    ...
    InstructionScreen = data.Routine(
        ...
        components=[textInstructions, keyInstructionContinue],
    )
    ...
    while continueRoutine:
        ...
        if keyInstructionContinue.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
    ...
    StartScreen = data.Routine(
        name='StartScreen',
        components=[textStartMessage, keyStart],
    )
    ...
    for thisBlockLoop in blockLoop:
        ...
        trialLoop = data.TrialHandler2(
            ...
            extraInfo=expInfo, 
            originPath=-1, 
            trialList=data.importConditions('Teamprojekt_Testphase/loopConditionsTeamprojekt.xlsx'), 
            seed=None, 
        )
        ...
        for thisTrialLoop in trialLoop:
            ...
            key_resp.rt = []
            _key_resp_allKeys = []
            ternusObjRight_2.setFillColor(ternusColor)
            ternusObjRight_2.setLineColor(ternusColor)
        ...
        breakText = (
            ...
            "Bitte drücke die 'J'-Taste, wenn sich die Elemente gemeinsam bewegen "
            "(Gruppenbewegung), und die 'F'-Taste, wenn sich die Elemente unabhängig "
            "voneinander bewegen (Elementbewegung).\n\n"
